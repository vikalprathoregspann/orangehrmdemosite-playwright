...
test('To test change language', async ({ HrmClaimPage,page,HrmClaimPageSetup}) => {
...
test('To test solutions->culture->careerDev', async ({ HrmClaimPage,page, HrmClaimPageSetup}) => {
    await HrmClaimPage.clickOnOrangehrmBtn()
